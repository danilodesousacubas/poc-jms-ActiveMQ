package br.com.poc.activemq.modelo;
...
@XmlRootElement // element raiz
@XmlAccessorType(XmlAccessType.FIELD) //Xml será baseados nos atributos, por padrão seria pelos getter e setters
public class Pedido implements Serializable{
	...
	@XmlElementWrapper(name="itens")// dentro de pedido, existirá um nó itens
	@XmlElement(name="item") // e será composto de (n) item
